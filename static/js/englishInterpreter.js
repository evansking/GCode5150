(function( codeEditor, undefined ) {
  ...
  **/
  codeEditor.interpretLine = function(gCodeLine) {
    ...
    "M561":"Set Identity Transform", "M562":"Reset temperature fault", "M563":"Define or remove a tool",
    "M564":"Limit axes", "M565":"Set Z probe offset", "M566":"Set allowable instantaneous speed change",
    "M567":"Set tool mix ratios", "M568":"Turn off/on tool mix ratios", "M569":"Set axis direction and enable values",
    "M570":"Configure heater fault detection", "M571":"Set output on extrude",
    "M572":"Set or report extruder pressure advance", "M573":"Report heater PWM", "M574":"Set endstop configuration",
    "M575":"Set serial comms parameters", "M577":"Wait until endstop is triggered", "M578":"Fire inkjet bits",
    "M579":"Scale Cartesian axes", "M580":"Select Roland", "M581":"Configure external trigger",
    "M582":"Check external trigger", "M583":"Wait for pin", "M584":"Set drive mapping", "M585":"Probe Tool",
    "M586":"Configure network protocols", "M587":"Store WiFi host network in list, or list stored networks",
    "M588":"Forget WiFi host network", "M589":"Configure access point parameters",
    "M590":"Report current tool type and index", "M600":"Set line cross section/Filament change pause",
    "M605":"Set dual x-carriage movement mode", "M665":" Set delta configuration",
    "M666":"Set delta endstop adjustment", "M667":"Select CoreXY mode", "M668":"Set Z-offset compensations polynomial",
    "M669":"Set SCARA mode and arm parameters", "M700":"Level plate", "M701":"Load filament", "M702":"Unload filament",
    "M703":"Get Board Type", "M710":"Erase the EEPROM and reset the board", "M750":"Enable 3D scanner extension",
    "M751":"Register 3D scanner extension over USB", "M752":"Start 3D scan", "M753":"Cancel current 3D scanner action",
    "M754":"Calibrate 3D scanner", "M755":"Set alignment mode for 3D scanner", "M756":"Shutdown 3D scanner",
    "M800":"Fire start print procedure", "M801":"Fire end print procedure", "M851":"Set Z-Probe Offset",
    "M900":"Set Linear Advance Scaling Factors", "M905":"Set local date and time", "M906":"Set motor currents",
    "M907":"Set digital trimpot motor", "M908":"Control digital trimpot directly", "M909":"Set microstepping",
    "M910":"Set decay mode", "M911":"Set power monitor threshold voltages",
    "M912":"Set electronics temperature monitor adjustment", "M913":"Set motor percentage of normal current",
    "M928":"Start SD logging", "M997":"Perform in-application firmware update", "M998":"Request resend of line",
    ...
    "M565":" Z offset: ", "M566":" Z axis : ", "M574":" Z axis: ", "M577":" Z axis: ", "M579":" Z axis: ",
    "M581":" endstop input(s) to monitor: ", "M584":" Z motor(s): ", "M585":" Z offset: ",
    "M600":" relative lift: ", "M665":" Z tower pos correction: ", "M666":" Z axis: ", "M667":" Z axis scale factor: ",
    "M851":" offset: ", "M906":" Z drive: ", "M907":" axis code (in % or amps): ", "M909":" Z stepper: ",
    "M910":" Z stepper: ", "M913":" % current for Z motor: "};
    ...
    "M420":" green PWM: ", "M566":" extruder drives : ", "M567":" mix ratios: ",
    "M574":" extruder endstops (low/high): ", "M577":" extruder drive: ", "M581":" endstop input(s) to monitor: ",
    "M584":" E motor(s): ", "M600":" initial retract: ", "M906":" E drive(s): ", "M907":" axis code (in % or amps): ",
    "M909":" E stepper: ", "M910":" E stepper: ", "M913":" % current for extruders: "};
    ...
    "M564": " axis boundaries: ", "M568":" 0=off,non-zero=on: ", "M569":" direction- 0=backwards,1=forwards: ",
    "M570": " heater timeout (in s): ", "M571":" output value: ", "M572":" pressure advance amount (in s): ",
    "M574":" logic level: ", "M575":" checksums: ", "M577":" endstop level: ", "M578":" bit pattern: ",
    "M581":" rising/falling edge: ", "M583":" state: ", "M584":" special functions: ", "M586":" 0=disable,1=enable: ",
    "M587":" network SSID: ", "M588":" SSID to remove: ", "M589":" SSID: ", "M605":" mode: ",
    "M665":" segments per second: ", "M667":" coreXY mode: ", "M669":" segments per second: ", "M752":" length/degrees: ",
    "M905":" time: ", "M907":" axis code (in % or amps): ", "M908":" current: ", "M911":" undervoltage threshold: ",
    "M912":" value to add to temp (in C): ", "M997":" firmware module number(s): "};
    ...
    "M563":" tool #: ", "M567":" tool #: ", "M568":" tool #: ", "M569":" motor driver #: ",
    "M570":" time (in s): ", "M571":" logical pin #: ", "M573": " heater #: ", "M575":" serial channel #: ",
    "M578":" inkjet head #: ", "M580":" initial text: ", "M581":" reserved: ", "M583":" pin #: ",
    "M586":" protocol: ", "M587":" network password: ", "M589":" WiFi password: ", "M669":" proximal arm length (mm): ",
    "M752":" filename: ", "M755":" turn on (> 0) or off (<= 0): ", "M905":" date: ", "M908":" pin: ",
    "M911":" power monitor channel: ", "M912":" temp monitor channel: ", "M998":" line #: ", "M999":" reset flags: "};
    ...
    var count = {"G0":0, "G1":0, "G2":0, "G3":0, "G4":"Dwell (pause)", "G6":0, "G10":0, "G11":0, "G20":0, "G21":0,
    "G22":0, "G23":0, "G28":0, "G29":0, "G29.1":0, "G29.2":0, "G30":0, "G31":0, "G32":0, "G33":0, "G60":0, "G61":0,
    "G90":0, "G91":0, "G92":0, "G100":0, "G130":0, "G131":0, "G132":0, "G133":0, "G161":0, "G162":0};

    var simp_comm = {"G0":"Move", "G1":"Move", "G2":"Move", "G3":"Move", "G4":"Dwell", "G6":"Move",
    "G10":"Tool Offset/Retract", "G11":"Unretract", "G20":"Units to Inches", "G21":"Units to mm",
    "G22":"Retract", "G23":"Unretract/Precharge", "G28":"Move to Origin", "G29":"Level bed",
    "G29.1":"Set Z probe head offset", "G29.2":"Set Z probe head offset", "G30":"Probes bed",
    "G31":"Set or Report Current Probe status/Dock Z Probe sled", "G32":"Probe Z and calculate Z plane/Undock Z Probe sled",
    "G33":"Measure/List/Adjust Distortion Matrix", "G60":"save current position to slot",
    "G61":"Apply/restore saved coordinates to the active extruder", "G90":"Set to Absolute Positioning",
    "G91":"Set to Relative Positioning", "G92":"Set Position", "G100":"Calibrate floor or rod radius",
    "G130":"Set digital potentiometer value", "G131":"Remove offset", "G132":"Calibrate endstop offsets",
    "G133":"Measure steps to top", "G161":"Home axes to min", "G162":"Home axes to max"};

    var s_x_comm = {"G0":" X: ", "G1":" X: ", "G2":" X: ", "G3":" X: ", "G10":" X: ", "G28":" flag ",
    "G29.1":" X: ", "G30":" X: ", "G31":" X: ", "G33":" X: ", "G61":" X: ", "G92":" new X: ", "G100":" flag ",
    "G130":" X: ", "G161":" flag ", "G162":" flag "};

    var s_y_comm = {"G0":" Y: ", "G1":" Y: ", "G2":" Y: ", "G3":" Y: ", "G10":" Y: ", "G28":" flag ",
    "G29.1":" Y: ", "G30":" Y: ", "G31":" Y: ", "G33":" Y: ", "G61":" Y: ", "G92":" new Y: ", "G100":" flag ",
    "G130":" Y: ", "G161":" flag ", "G162":" flag "};

    var s_z_comm = {"G0":" Z: ", "G1":" Z: ",
    "G28":" flag ", "G29.1":" Z offset: ", "G29.2":" Z: ", "G30":" Z: ", "G31":" trigger Z height: ", "G33":" Z: ",
    "G61":" Z: ", "G92":" new Z: ", "G100":" flag ", "G130":" Z: ", "G161":" flag ", "G162":" flag "};

    var s_e_comm = {"G0":" extrude: ", "G1":" extrude: ", "G2":" extrude: ", "G3":" extrude: ", "G10":" Z: ",
    "G61":" E: ", "G92":" new extruder: "};

    var s_f_comm = {"G0":" feed: ", "G1":" feed: ", "G2":" feed: ", "G3":" feed: ", "G61":" feed: ",
    "G161":" feed: ", "G162":" feed: "};

    var s_s_comm = {"G0":" flag: ", "G1":" flag: ", "G4": " wait: ", "G10":" temp or length: ", "G11":" length: ",
    ...
    var s_p_comm = {"G4": " wait: ", "G10":" tool #: ", "G30":" probe point #: ", "G31":" trigger value: ",
    "G32":" method: "};
